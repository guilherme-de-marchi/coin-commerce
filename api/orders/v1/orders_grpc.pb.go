...
const (
	OrderService_List_FullMethodName       = "/api.orders.v1.OrderService/List"
	OrderService_ListByUser_FullMethodName = "/api.orders.v1.OrderService/ListByUser"
	OrderService_Get_FullMethodName        = "/api.orders.v1.OrderService/Get"
	OrderService_Create_FullMethodName     = "/api.orders.v1.OrderService/Create"
	OrderService_Delete_FullMethodName     = "/api.orders.v1.OrderService/Delete"
)
...
func (c *orderServiceClient) ListByUser(ctx context.Context, in *ListByUserRequest, opts ...grpc.CallOption) (*ListByUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderService_ListByUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.orders.v1.OrderService",
